<template>
	...
	<view class="toolbar">
		...
		<view class="box" v-else>
			<image src="/static/basic/likeed.png" style="width: 80%;height: 80%;border-radius: 50%;" @click="like" :class="{ani:isAni}" class="likeed"></image>
		</view>
		<view class="box">
			<image src="/static/basic/download.png" style="width: 80%;height: 80%;border-radius: 50%;"></image>
		</view>
		<view class="box">
			<image src="/static/basic/share.png" style="width: 80%;height: 80%;border-radius: 50%;" @click="share"></image>
		</view>
	</view>
</template>
